...
Joel H. Nitta^1,\*^ and Eric Schuettpelz^2^
...
Any conservation policy seeking to mitigate this damage depends on documenting biodiversity while at the same time determining the processes that generate it [@Smith1993c].
...
Abundance is a key parameter for understanding the distribution of biodiversity, as it governs the existence of local populations and ultimately species, and gaining a better understanding of the processes governing abundance is critical to conserving biodiversity in the Anthropocene [@Brown1995].
...
A much smaller population center in New Zealand is likely due to recent introduction and naturalization [@Brownsey2017].
...
It is likely that processes occurring simultaneously at multiple scales interact to determine abundance [@Brown1984].
At broad (global) scales, climate change operates to shift species distributions primarily along latitudinal gradients [@Chen2011].
Changes in land use by humans also operates to influence species distributions at large scales. [@Daskalova2020; @Williams2020]
Within these larger forces, processes acting at the regional to local scale such as distribution of soil type and local climate further influence species distribution and abundance [@Lafleur2010].
...
Mathematical models, in particular linear regression models, have long been a key tool for understanding ecology [@Bolker2009a].
...
This is due to the extremely complex nature of ecology, which includes many interacting processes across multiple scales [@Graham2003].
...
While this is a promising approach for understanding ecological processes, it has not been widely applied in ecology, perhaps due to the dominant statistical paradigm that has focused on explanation rather than prediction [@Elith2008].
